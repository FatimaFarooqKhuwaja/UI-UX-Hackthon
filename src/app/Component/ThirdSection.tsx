...
const ThirdSection = () => {
  return (
    <>
    <div>
        <h2 className="text-black text-[20px] sm:text-[22px] font-[700] ml-[40px] mb-[15px] mt-[80px]">Gear Up</h2>
       
<div className="lg:flex lg:justify-around mb-[100px] ">
  ...
  {/* first div cards */}
          ...
          {/* Card 1 */}
          <div className="bg-white shadow-lg rounded-lg overflow-hidden w-[290px] h-[400px]">
            <Image
              src={gearupImg1}
              alt="Nike Air Max Pulse"
